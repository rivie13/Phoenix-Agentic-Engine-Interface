...
**Examples:**
- `subfeature/task/add-tool-result-types`
- `subfeature/bugfix/fix-contract-schema-drift`
- `subfeature/refactor/split-client-modules`
- `subfeature/test/add-contract-validation-tests`
...
- `contract/<short-topic>` — schema/fixture work
...
- PR description should include (use MCP tools to set):
  ...
  - **Breaking changes**: Backward compatibility notes (especially contracts)
...
- Target: subfeature PRs should ideally be under ~400 lines of meaningful change (excluding generated files, lock files, fixtures).
