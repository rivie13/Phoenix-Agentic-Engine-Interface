...
| **Feature** | Single repo deliverable | Days–weeks | `feature` | "Add AuthToken contract types" |
| **Task** | Single PR unit of work | Hours–days | `task` | "Define AuthTokenPayload Zod schema" |
